...
if($_SERVER["REQUEST_METHOD"] == "POST" )
{
    ...
    if($num == 0)
    {
        ...
        {
            $sqll = "INSERT INTO `user` (`name`, `email`, `password`, `cpassword`, `address`, `pcode`, `contact`, `state`) VALUES ('$name', '$email', '$password', '$cpassword', '$address', '$pcode', '$contact', '$state')";
            ...
            <form method="post">
                ...
                <div class="row justify-content-center">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" id="inputCity" placeholder="Full Name" required name="name"> 
                    </div> 
                    <div class="form-group col-md-3">
                ...
                <div class="row justify-content-center">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" id="inputCity" placeholder="Address" required name="address">
                    </div> 
                    <div class="form-group col-md-3">
                        <label for="inputCity">Pin Code</label>
                        <input type="text" class="form-control" id="inputCity" placeholder="Pin code" name="pcode">
                    </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select id="inputState" class="form-control" name="state">
                            <option selected>Uttrakahnd</option>
                            <option>Delhi</option>
                        </select>
                    </div>  
                </div>
                <button type="submit" class="btn btn-primary" style="margin-left: 48%;">Register</button>
            </form>
        </div>
    </div>
